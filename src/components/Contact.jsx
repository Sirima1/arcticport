...
const Contact = ({id}) => {
  ...
  return (
    ...
    className='leading-4 mt-4 ' >I Have 5 years Experience in the field of Information Technology with Expertise in the following technologies;-
    ...
    <div id="skill" className="lg:flex mt-4 block gap-8 align-center justify-center">
    ...
    <h1 className="font-bold" >Django  <span className="font-bold p-5 flex text-xl">95%</span></h1>
